...
Section \secref{sec:succrit} identified and critiqued similar research found in the literature. The following paragraphs conduct a further evaluation of the common design patterns identified with a view to formulating a model process for the applied experimental stage of this project.

## Experimental Design Factors

\textbf{Objective and guiding principles:} The objective of the experimental stage is ultimately to compare a novel technique against existing benchmark techniques. However, the literature review has unearthed a plethora of variations, tweaks and tunings for an ARM based imputation technique, any of which may improve general performance. It will be computationally and operationally very difficult to run all possible variants, let alone to compare them against the several benchmarks. Yet, there is a real motivation to find an optimally performing variant of the technique or there is a risk of failing to discover the novel technique's true potential. The literature review also discussed several data scenarios which should be explored in order to investigate any niche uses for the novel technique. However, in some cases this is secondary to the benchmarking comparison at this stage of the research and only specific scenarios will be considered.
