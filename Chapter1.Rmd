...
Since association rules mining (ARM) was proposed, the concept has been the subject of intense research. ARM is best suited to applications on categorical data. While the technique is inherently a descriptive, knowledge discovery tool, it has been successfully adapted for classification. However, a detailed review of the literature finds very scarce previous examples of an association rules based method for imputation, and none that specifically address the challenge of ordinal data. This research develop, test and benchmark a new algorithm that applies ARM to the problem of imputation.
...
Table \@ref(tab:resdes) lists the research method that will be used to meet each objective. Research methods specifically suited for computer science projects include Model, Build and Experimental, proposed in @amaral2011computing. The algorithm will be developed as a software package for R, following the methodology and best practices (version control, automated tests, namespaces and documentation) proposed in @Wickham:2015:RP:2904414.
...
The remaining chapters of this report are organized as follows: Chapter 2 provides a comprehensive literature review covering objectives 1-5 and laying the foundation for the applied project. Chapter 3 describes the choice of experimental methodology and applied research in detail. Chapter 4 is a listing of results along with various graphs and figures. Chapter 5 follows with a detailed discussion of the results and their interpretation. Chapter 6 brings the report to a conclusion, reviewing the most important finding, suggesting further work and finally a self-reflection on the project process, methods and objectives.