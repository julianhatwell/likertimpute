...
Table \@ref(tab:objectives) lists the research method that will be used to meet each objective:
...
The remaining chapters of this report are organized as follows: Chapter 2 provides a comprehensive literature review covering objectives 1-5 and laying the foundation for the applied project. Chapter 3 describes the choice of experimental methodology and applied research in detail. Chapter 4 contains the tabulated results along with various graphs and figures of the most interesting results. Chapter 5 follows with a detailed discussion of the results and their interpretation. Chapter 6 brings the report to a conclusion, reviewing the most important finding, suggesting further work and finally a self-reflection on the project process, methods and objectives.